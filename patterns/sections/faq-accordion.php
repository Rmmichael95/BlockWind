...
<div class="wp-block-group alignfull has-dh-text-color has-dh-base-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--fluid-2xl);padding-right:var(--wp--preset--spacing--fluid-xl);padding-bottom:var(--wp--preset--spacing--fluid-2xl);padding-left:var(--wp--preset--spacing--fluid-xl)">
	...
	<div class="wp-block-group">
		...
		<!-- wp:details {"backgroundColor":"dh-surface","style":{"spacing":{"padding":{"top":"var:preset|spacing|fluid-m","bottom":"var:preset|spacing|fluid-m","left":"var:preset|spacing|fluid-m","right":"var:preset|spacing|fluid-m"}},"border":{"radius":"var(--wp--custom--tokens--radius--m,12px)"}}} -->
		<details class="wp-block-details has-dh-surface-background-color has-background" style="border-radius:var(--wp--custom--tokens--radius--m,12px);padding-top:var(--wp--preset--spacing--fluid-m);padding-right:var(--wp--preset--spacing--fluid-m);padding-bottom:var(--wp--preset--spacing--fluid-m);padding-left:var(--wp--preset--spacing--fluid-m)"><summary>Does BlockWind require Tailwind?</summary><p>No. Tailwind modules are optional and opt-in via Vite imports.</p></details>
		<!-- /wp:details -->
