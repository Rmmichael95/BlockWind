...
<div class="wp-block-group alignfull has-bw-text-color has-bw-surface-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--fluid-2xl);padding-right:var(--wp--preset--spacing--fluid-xl);padding-bottom:var(--wp--preset--spacing--fluid-2xl);padding-left:var(--wp--preset--spacing--fluid-xl)">
	...
	<div class="wp-block-group">
		...
		<h2 class="wp-block-heading has-text-align-center">Built for real client work</h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					...
					<p style="font-weight:700">✓ Semantic tokens</p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph -->
					<p>Swap palettes safely across sites.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					<!-- wp:paragraph {"style":{"typography":{"fontWeight":"700"}}} -->
					<p style="font-weight:700">✓ Minimal templates</p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph -->
					<p>Patterns do the heavy lifting.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					<!-- wp:paragraph {"style":{"typography":{"fontWeight":"700"}}} -->
					<p style="font-weight:700">✓ No bloat</p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph -->
					<p>Opt-in CSS build output only.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					<!-- wp:paragraph {"style":{"typography":{"fontWeight":"700"}}} -->
					<p style="font-weight:700">✓ Accessible defaults</p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph -->
					<p>High-contrast roles by design.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					<!-- wp:paragraph {"style":{"typography":{"fontWeight":"700"}}} -->
					<p style="font-weight:700">✓ Modular nav</p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph -->
					<p>Nav/dropdowns/offcanvas split cleanly.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					<!-- wp:paragraph {"style":{"typography":{"fontWeight":"700"}}} -->
					<p style="font-weight:700">✓ Easy theming</p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph -->
					<p>Style variations are first-class.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
